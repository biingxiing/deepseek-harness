...
- `@deepseek-ai/dsh-command-add-plugin` — requires `commands` · `loader` ([`packages/interaction/command-add-plugin/src/index.ts`](../packages/interaction/command-add-plugin/src/index.ts))
