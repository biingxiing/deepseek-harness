...
- `@deepseek-ai/dsh-command-add-plugin` — 需要 `commands` · `loader`（[`packages/interaction/command-add-plugin/src/index.ts`](../packages/interaction/command-add-plugin/src/index.ts)）
